      ...
      <CardContent className="flex-1 overflow-hidden flex flex-col p-0">
              ...
              <div
                ...
                className={`flex gap-3 p-4 rounded-lg transition-all ${
                  msg.role === "assistant"
                    ...
                    : msg.role === "user"
                    ? "bg-green-500/10 dark:bg-green-500/20 border-l-4 border-green-500 dark:border-green-400"
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  {msg.role === "assistant" ? (
                    ...
                    <div className="flex items-center justify-center h-8 w-8 rounded-full bg-green-500 dark:bg-green-400">
        ...
        <div className="border-t p-4 space-y-2 bg-muted/30">
          ...
          <p className="text-xs text-muted-foreground text-center">
            💡 Ao enviar uma mensagem, a IA será pausada automaticamente. 
            Use o botão acima para reativá-la.
          </p>
        </div>
      </CardContent>
    </Card>
